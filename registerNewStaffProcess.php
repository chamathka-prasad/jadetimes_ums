...
if (isset($_SESSION["jd_admin"])) {
    ...
    if ($uid == 0) {
        ...
        if ($checkUserAvailableResultSet->num_rows != 0) {
            ...
            if ($resultsUser->num_rows == 0) {
                ...
                Database::operation("INSERT INTO `staff`(`user_id`,`reg_date`)VALUES('" . $uid . "','" . $date . "')", "iud");

                $messageEdit = "New Staff Member Registred Success. ";
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Jade times Staff Allocation Message';
    ...
    ';
                ...
                if (!$mail->send()) {
                    ...
                    $message->message = $messageEdit . "Message sent to email";
                }
                ...
                $message->type = "error";
                $message->message = "User Already Registred to Staff";
                echo json_encode($message);
            }
        } else {
            $message->type = "error";
