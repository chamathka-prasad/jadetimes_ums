                ...
                <a id="userSettings" class="dropdown-toggle d-flex py-2 align-items-center ps-3 border-start" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <img src="<?php if (empty($user["imgPath"])) {
                                ?>assets/img/defaultProfileImage.png<?php
                                                                    ...
                                                                    echo "resources/profileImg/" . $user["imgPath"];
                                                                }  ?>" class="rounded-circle img-3x" alt="Bootstrap Gallery" />
                </a>
                <div class="dropdown-menu dropdown-menu-end shadow">
                    <a class="dropdown-item d-flex align-items-center" href="userProfile.php"><i class="bi bi-person fs-4 me-2"></i>Profile</a>
              
                    <a class="dropdown-item d-flex align-items-center" href="userLogOutProcess.php"><i class="bi bi-escape fs-4 me-2"></i>Logout</a>
                </div>
            </div>
        </div>
