...
?>
	...
	<head>
		...
		<title>Jade Times - update user profile </title>
					...
					<div class="app-hero-header d-flex align-items-start">
						...
						<div class="ms-auto d-flex flex-row">
							<div class="d-flex flex-column me-5 text-end">
								...
								<h3 class="m-0"><?php echo $userSession["jid"] ?></h3>
							</div>
								...
								<div class="card mb-4">
									<div class="card-body">
										...
										<div class="row align-items-center">
											...
											<div class="col">
												<h4 class="m-0"><?php echo $userSession["fname"] . " " . $userSession["lname"] ?></h4>
												<h6 class="text-primary"><?php echo $userSession["department"] ?></h6>


											</div>

											<div class="col-12 bg-light-subtle col-md-auto text-center">
												<h5 class="m-0 text-primary"><?php echo $userSession["position"] ?></h5>
											</div>
										</div>
										<!-- Row end -->
									</div>
									...
									<div class="card-body">
										<div class="custom-tabs-container">
											...
											<div class="tab-content" id="customTabContent">
												...
												<?php
												$resultProfile = Database::operation("SELECT `user`.`id`,`user`.`email`,`user`.`fname`,`user`.`lname`,`user`.`sname`,`user`.`mname`,`user`.`mobile`,`user`.`duration`,`user`.`linkdin`,`user`.`jid`,`user`.`nic`,`user`.`dob`,`type`.`name` AS `user_type`,`position`.`name` AS `position`,`department`.`name` AS `department`,`user`.`gender_id` AS `genderId` FROM `user` INNER JOIN `type` ON  `type`.`id`=`user`.`type_id` INNER JOIN  `user_status` ON `user`.`user_status_id`=`user_status`.`id`
 INNER JOIN `position` ON `position`.`id`=`user`.`position_id` INNER JOIN `department` ON `department`.`id`=`position`.`department_id`  WHERE `user`.`id`='" . $userSession["id"] . "';", "s");
												...
												?>
													<script src="userLogin.php"></script>
												<?php
												}
												?>
																	...
																	<div class="row">
																				...
																				<div class="card-body">
																					<div class="row">
																						<div class="col-sm-12 text-center">
																							<img class="imageSize" src="<?php if (empty($userSession["imgPath"])) {
																														?>assets/img/defaultProfileImage.png<?php
																																		} else {
																																			echo "resources/profileImg/" . $userSession["imgPath"];
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<input type="text" disabled id="sname" class="form-control removeCorner" value="<?php echo $Profile["sname"] ?>" placeholder="Enter Surname" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				<label class="form-label ">First Name</label>
																				<input type="text" disabled id="fname" class="form-control removeCorner" placeholder="Enter First Name" value="<?php echo $Profile["fname"] ?>" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				<label class="form-label">Middle Name</label>
																				<input type="text" disabled id="mname" class="form-control removeCorner" placeholder="Enter Middle Name" value="<?php echo $Profile["mname"] ?>" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				<label class="form-label">Last Name</label>
																				<input type="text" disabled id="lname" class="form-control removeCorner" placeholder="Enter Last Name" value="<?php echo $Profile["lname"] ?>" />
																			</div>
																		</div>
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<input type="email" id="email" class="form-control removeCorner" disabled placeholder="Enter email address" value="<?php echo $Profile["email"] ?>" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				<label class="form-label">Phone</label>
																				<input type="text" disabled id="mobile" class="form-control removeCorner" placeholder="Enter phone number" value="<?php echo $Profile["mobile"] ?>" />
																			</div>
																		</div>
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<input type="text" disabled id="nic" class="form-control removeCorner" placeholder="national ID" value="<?php echo $Profile["nic"] ?>" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				<label class="form-label">Date Of Birth</label>
																				<input type="date" disabled id="dob" class="form-control removeCorner" placeholder="date of birth" value="<?php echo $Profile["dob"] ?>" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<input type="text" disabled id="no" class="form-control removeCorner" value="<?php echo $num ?>" placeholder="Enter no" />
																			</div>
																		</div>
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<input type="text" disabled id="line1" class="form-control removeCorner" value="<?php echo $line1 ?>" placeholder="Enter Line 1" />
																			</div>
																		</div>
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<input type="text" disabled id="line2" class="form-control removeCorner" value="<?php echo $line2 ?>" placeholder="Enter Line 2" />
																			</div>
																		</div>
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				<label class="form-label">City</label>
																				<input type="text" disabled id="city" class="form-control removeCorner" value="<?php
																																						echo $cit
																		...
																		<div class="col-lg-3 col-sm-4 col-12">
																			<div class="mb-3">
																				...
																				<select class="form-select removeCorner" disabled id="country">
																					<option value="0">Select</option>
