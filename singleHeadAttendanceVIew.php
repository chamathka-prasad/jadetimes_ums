...
INNER JOIN `position` ON `position`.`id`=`user`.`position_id` INNER JOIN `department` ON `department`.`id`=`position`.`department_id` LEFT JOIN `profile_image` ON `profile_image`.`user_id`=`user`.`id`  WHERE `attendance`.`id`='" . $attendanceId . "' AND `department`.`name`='" . $admin["department"] . "'", "s");
...
?>
		<script>
			window.location = "headAttendence.php";
		</script>
	<?php
	}
	?>
				...
				<div class="app-container">
					...
					<div class="app-hero-header d-flex align-items-start">
						...
						<ol class="breadcrumb d-none d-lg-flex align-items-center">
							...
							<li class="breadcrumb-item"><a href="headAttendence.php">Department Aattendance</a></li>
