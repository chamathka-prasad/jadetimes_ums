...
?>
							...
							<div class="col-12">
								<div class="mb-3">
									...
									<select class="form-select removeCorner" id="adduser" onchange="employeeCalenderView()">
										...
										$userResultAttendance = Database::operation("SELECT * FROM `user` WHERE `user`.`user_status_id`='1' AND `type_id`IN('1','2','4')", "s");
	...
	<script>
		...
		function employeeCalenderView() {
			...
			fetch(baseUrl + "adminfetchUserAttendanceCalenderProcess.php?id=" + id, {
					method: "GET",
					headers: {
