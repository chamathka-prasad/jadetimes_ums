...
?>
	...
	<head>
		...
		<title>Jade Times - Manage Reports / change status</title>
	...
	<body class="backgroundColorChange" onload="loadUserReports(0)">
				...
				<div class="app-container">
					...
					<div class="app-hero-header d-flex align-items-start">
						...
						<ol class="breadcrumb d-none d-lg-flex align-items-center">
							...
							<li class="breadcrumb-item" aria-current="page">Manage Reports</li>
						</ol>
						<!-- Breadcrumb end -->
							...
							<div class="col-lg-12 col-sm-12 col-12 text-center">
								<div class="mb-3">
									<div class="row">
										...
										<div class="col-9">
											<select id="select-state" class="form-select removeCorner smallText" onchange="loadUserReports(1)">
	...
	<script>
		function loadUserReports(stat) {
			...
			tablebody.innerHTML = "";
			fetch(baseUrl + "userReportLoadProcess.php", {
					method: "POST",
					body: formData,
				...
				.then(function(value) {
					...
					if (value.type == "success") {
						...
						for (let index = 0; index < userSearchData.length; index++) {
							...
							if (user[6] == "1") {
								date.textContent ="Noted";
							} else {
								date.innerHTML = `<button class="btn btn-primary removeCorner backgroundColorChange " onclick="markAsNoted(${user[7]})">Mark As Noted</button>`;
							}
		...
		function markAsNoted(id) {

			var formData = new FormData();
			formData.append("id", id);
			fetch(baseUrl + "reportMarkAsNoted.php", {
					method: "POST",
					body: formData,
				...
				.then(function(resp) {
					...
					try {
						...
						window.location="manageReports.php";
					}
